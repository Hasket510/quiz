...
export const question: Record<TTestWorld, TQuestion[]> = {
	...
	diablo: [
		...
		},
		{
			...
			correct: 3,
			pic: Pics.diabloQuestion5,
		},
		{
			question:
				'Если засунуть в этот куб том городского портала (Tome of Town Portal) и ногу Вирта (Wirt’s Leg), то можно попасть…в.',
			variants: [
		...
		},
		{
			...
			correct: 2,
			pic: Pics.diabloQuestion8,
		},
		{
			question:
				'А ещё Diablo III есть свой секретный уровень «Чудо-страна» (Whimsyshire), с разноцветными единорогами. Знаете, как туда попасть?',
			variants: [
	...
	starcraft: [
		...
		},
		{
			...
			correct: 2,
			pic: Pics.starCraftQuestion5,
		},
		{
			question:
				'В каком титуле находилась Талис на момент пролога Legacy of the Void?',
			variants: ['Вершитель', 'Прелат', 'Претор', 'Высшая посвящённая'],
			correct: 2,
			pic: Pics.starCraftQuestion6,
		},
		{
			question: 'На сколько подчастей был разделён аддон Нова: незримая война?',
			variants: ['9', '5', '3', '2'],
			correct: 2,
			pic: Pics.starCraftQuestion7,
		},
		{
			question:
